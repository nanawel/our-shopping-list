...
const currentBoardSlugKey = config.VITE_APP_LOCALSTORAGE_KEY_PREFIX + 'currentBoardSlug'
const currentListSlugKey = config.VITE_APP_LOCALSTORAGE_KEY_PREFIX + 'currentListId'
