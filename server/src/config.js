...
let config = {
  ...
  VITE_APP_DISABLE_PASTE_CSV: !!parseInt(process.env.VITE_APP_DISABLE_PASTE_CSV),
  VITE_APP_EDIT_ITEM_ON_CREATE: !!parseInt(process.env.VITE_APP_EDIT_ITEM_ON_CREATE),
  VITE_APP_ENV: mode,
  VITE_APP_HIDE_FORCE_REFRESH_HINT: !!parseInt(process.env.VITE_APP_HIDE_FORCE_REFRESH_HINT),
  ...
  VITE_APP_PASTE_CSV_SEPARATOR: process.env.VITE_APP_PASTE_CSV_SEPARATOR || ',',
